...
# 🏨 Сервис бронирования отелей | Hotel Booking Service API

Современный REST API для системы бронирования отелей на FastAPI с полным стеком технологий.
...
- Автоматические уведомления о заезде
  ...
  **Внимание! Чтобы пронировать номера нужно зарегистрироваться и выполнить вход в систему!**

### 🖼️ Медиа
- Загрузка изображений отелей
- Автоматическое создание ресайзов
...
- 🧹 **Чистая Архитектура** - используется многослойная архитектура (Layered Architecture), разделяющая код на независимые слои Domain, Application, Infrastructure, Presentation:<br><br>
...
- ⚡  **SOLID** - Проект следует принципам SOLID:
...
- Уведомления о заезде (проверка бронирований)


## 🛠️ ⚙️ Сборка и запуск проекта
